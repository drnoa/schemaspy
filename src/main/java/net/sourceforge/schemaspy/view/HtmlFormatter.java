...
public class HtmlFormatter {
    ...
    protected void writeHeader(Database db, String text, LineWriter out) throws IOException {
        ...
        out.write(getDescription(db, null, text, false));
        out.writeln("</title>");
        ...
        out.writeln("  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='jquery.js'></SCRIPT>");
        out.writeln("  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='schemaSpy.js'></SCRIPT>");
        out.writeln("  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='jquery.tablesorter.js'></SCRIPT>");
        ...
        out.write(getDescription(db, null, text, true));
        out.write("</span>");
